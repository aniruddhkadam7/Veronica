...
//! `crate::personal::DirectLlmClient` for Veronica/Notes/Analysis/Setup —
//! this personal build has no HTTP backend client; every AI call goes
//! directly to the configured provider (OpenAI/Anthropic/Gemini). See
